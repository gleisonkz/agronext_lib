...
from ...utils import format_address_line, format_city_state, format_decimal
...
def build_policy_data_from_domain(
    ...
    return PolicyDocumentData(
        ...
        insured_document=insured_data.cpf,
        insured_birth_date=insured_data.birth_date,
        insured_additional_document=insured_data.document_number,
        insured_document_issuing_authority=insured_data.issuing_authority,
        insured_document_issue_date=insured_data.issue_date,
        insured_email=insured_data.main_email,
        ...
        insured_phone=insured_data.phone_number,
        property_address=format_address_line(property_data.street, property_data.number),
        property_neighborhood=property_data.neighborhood,
        property_zip_code=property_data.zip_code,
        property_city_state=format_city_state(property_data.city, property_data.state),
        ...
        broker_susep_code=broker_data.susep,
        ...
        lmga=coverage_data.policy_limit_brl,
        bacen_code="11283005",
        insured_items=str(insured_items_count),
        total_premium=coverage_data.net_premium,
        beneficiaries=beneficiaries_data,
        coverage_lines=coverage_lines,
        policy_net_premium=coverage_data.net_premium,
        policy_cost="R$ 0,00",
        iof="R$ 0,00",
        premium_to_pay=coverage_data.applicant_value,
