...
def build_proposal_proponent_declaration() -> ProponentDeclarationData:
    content_html = """
<p><u><strong>DECLARO</strong></u> que tomei ciência das Condições dos Programas de Subvenção ao Prêmio do Seguro dos Governos Federal e Estadual e <strong>ESTOU DE ACORDO COM SUAS CONDIÇÕES.</strong></p>
...
<p><u><strong>DECLARO</strong></u> ter ciência e <strong>CONCORDO</strong> com as Condições Gerais deste seguro, para as quais não tenho dúvidas, acatando-as como parte integrante desta proposta.</p>
