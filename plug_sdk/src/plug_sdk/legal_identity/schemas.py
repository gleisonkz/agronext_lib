...
class Metadata(BaseModel):
    last_event_id: str = Field(alias="lastEventID", description="UUID of the last event in Neoway for the legalentity")
...
class LegalEntity(BaseModel):
    name: Optional[str] = Field(None, alias="razaoSocial", description="Corporate name of the legalentity")
...
class LegalEntityResponse(BaseModel):
    cnpj: str = Field(alias="_id", description="CNPJ of the legalentity")
    trade_name: Optional[str] = Field(None, alias="razaoSocial", description="Corporate name of the legalentity")
    registration_date: datetime = Field(alias="data", description="Date of registration situation")
    status: str = Field(alias="status", description="LegalEntity status")


class NaturalPersonInfo(BaseModel):
    name: str = Field(alias="nome", description="Full name of the naturalperson")
    status: str = Field(alias="situacao", description="Status of the naturalperson")
...
class PlugNaturalPersonResponse(BaseModel):
    ...
    birth_date: Optional[datetime] = Field(None, alias="dataNascimento", description="Birth date of the naturalperson")
    person_info: NaturalPersonInfo = Field(alias="pessoa", description="Detailed naturalperson information")
