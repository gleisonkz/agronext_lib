...
class HTTPClient:
    ...
    @staticmethod
    def _parse_json_response(response: httpx.Response) -> Optional[Dict[str, Any]]:
        """Parse JSON body, or return None for empty responses (e.g. 204 / make_private)."""
    ...
    async def get(
        ...
        *,
        ...
        """Make GET request and return JSON response (None if body is empty)."""
    ...
    async def post(
        ...
        *,
        ...
        """Make POST request and return JSON response (None if body is empty)."""
        url = self._build_url(path)
    ...
    async def put(
        ...
        *,
        ...
        """Make PUT request and return JSON response (None if body is empty)."""
        url = self._build_url(path)
